...
public class DForgot extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 960, 400));
        ...
        jLabel2.setText("Please enter your username to proceed");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 90, 370, 290));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, -1, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Hospital/Princeton/Forgot.jpg"))); // NOI18N
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
          try {
            ...
            PreparedStatement ps = c.con.prepareStatement("SELECT username, recovery, id FROM doctors");
    ...
    private void submit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit1ActionPerformed
        try{
            ...
            PreparedStatement ps = c1.con.prepareStatement("SELECT ans from doctors WHERE id ="+id+";");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
            ...
            if(ss.equals(sss)){
                 Connect c = new Connect();
                PreparedStatement ps = c.con.prepareStatement("UPDATE doctors SET password = '"+ss+"' WHERE id = "+id+" ");
                ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DForgot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
