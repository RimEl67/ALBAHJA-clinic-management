...
public class DelPha extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DelPha
     */
    public DelPha() {
        super("Delete a Pharmacist Account");
        initComponents();
        showPha();
    }
    ...
    private void showPha(){
        try {
            Connect c = new Connect();
            PreparedStatement ps = c.con.prepareStatement("SELECT fname, lname, username FROM pharmacists");
    ...
    private void del(){
        ...
        try {
            ...
            Connect c = new Connect();
            PreparedStatement ps = c.con.prepareStatement("DELETE FROM pharmacists WHERE username = '" +username+"';");
            
            ps.executeUpdate();
            JOptionPane.showMessageDialog(rootPane, "Successfully deleted pharmacist account");
            showPha();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelPha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
