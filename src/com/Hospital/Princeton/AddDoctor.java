...
public class AddDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 685));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            PreparedStatement s = c2.con.prepareStatement("select username from doctors");
            ...
            if(true){
                ...
                if(flag == 1){
                    ...
                    PreparedStatement ps = c.con.prepareStatement("insert into doctors values(?,?,?,?,?,?,?,?,?,?,?)");
